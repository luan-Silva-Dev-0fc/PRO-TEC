...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-black text-white p-9 relative">
      <div className="w-full max-w-[1100px]">
        ...
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-7">
          <a href="#" className="flex items-center gap-3 text-white no-underline">
            <div className="w-14 h-14 relative rounded-lg overflow-hidden">
              <Image src="/logo/logo.jpg" alt="Logo PRO TEC" fill style={{ objectFit: "cover" }} />
            </div>
            <div>
        ...
        <main className="grid md:grid-cols-[1fr_360px] gap-6 items-center p-7 rounded-lg bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] backdrop-blur-sm">
          <section>
            <motion.div variants={container} initial="hidden" animate="show">
              ...
              <motion.h1 variants={item} className="text-3xl md:text-4xl font-extrabold mb-2 leading-snug">
                Conheça nosso processo de <strong>dedetização eficiente e seguro</strong>
              </motion.h1>

              <motion.p variants={item} className="text-gray-300 mb-4 text-sm md:text-base">
                Garantimos resultados duradouros com técnicas profissionais e produtos aprovados — protegendo sua casa ou empresa com responsabilidade.
              </motion.p>
            </motion.div>
            ...
            <div className="mt-6 grid md:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)]">
                ...
                <p className="text-gray-300 text-sm">
                  Avaliação completa para identificar focos, pragas e pontos críticos antes do tratamento.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)]">
                <h4 className="font-bold mb-2">Aplicação</h4>
                <p className="text-gray-300 text-sm">
                  Produtos seguros e técnicas qualificadas para eliminar pragas com eficiência.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)]">
                <h4 className="font-bold mb-2">Limpeza de caixas</h4>
                <p className="text-gray-300 text-sm">
                  Limpeza e higienização de caixas de gordura, com descarte responsável dos resíduos.
                </p>
              </div>
            </div>

            <div className="mt-6 flex flex-wrap gap-3">
              <div className="inline-block px-3 py-1 rounded-full bg-[rgba(255,255,255,0.04)] text-gray-300 font-bold">Técnicos qualificados</div>
              <div className="inline-block px-3 py-1 rounded-full bg-[rgba(255,255,255,0.04)] text-gray-300 font-bold">Produtos aprovados</div>
              <div className="inline-block px-3 py-1 rounded-full bg-[rgba(255,255,255,0.04)] text-gray-300 font-bold">Atendimento rápido</div>
            </div>
          </section>
          ...
          <aside className="p-4 rounded-lg bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
            ...
            <div className="mt-3">
              <div className="text-[13px] text-gray-300">Gleison Nascimento — PRO TEC</div>
              <div className="text-gray-300 text-sm mt-1">Orçamento sem compromisso.</div>
            </div>
      ...
      <a href={whatsappLink()} target="_blank" rel="noopener noreferrer" className="fixed bottom-5 right-5 w-20 h-20 z-50">
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-black p-6 rounded-xl max-w-sm w-full border border-[rgba(255,255,255,0.06)]">
            ...
            <p className="text-gray-300 mb-4">
              Clique no botão abaixo e envie uma mensagem no WhatsApp para solicitar seu orçamento.
            </p>
            <a
              href={whatsappLink("Olá! Gostaria de solicitar um orçamento da PRO TEC Dedetizadora.")}
              target="_blank"
              rel="noopener noreferrer"
