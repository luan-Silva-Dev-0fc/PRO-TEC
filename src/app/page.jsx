  ...
  return (
    ...
    >
      ...
      <span className="ml-6 relative">
        <svg width="40" height="28" viewBox="0 0 66 43" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <path className="one" d="M40.154,3.895 L43.976,0.139 65.692,20.785 65.704,22.199 44.677,42.861 43.976,42.861 40.154,39.107 40.148,38.400 56.994,21.857 57.000,21.150 40.154,4.608 40.148,3.901 Z" fill="#000"/>
            <path className="two" d="M20.154,3.895 L23.976,0.139 45.692,20.785 45.704,22.199 24.677,42.861 23.976,42.861 20.154,39.107 20.148,38.400 36.994,21.857 37.000,21.150 20.154,4.608 20.148,3.901 Z" fill="#000"/>
            <path className="three" d="M0.154,3.895 L3.976,0.139 25.692,20.785 25.704,22.199 4.677,42.861 3.976,42.861 0.154,39.107 0.148,38.400 16.994,21.857 17.000,21.150 0.154,4.608 0.148,3.901 Z" fill="#000"/>
          </g>
        </svg>
      </span>
      ...
      <style jsx>{`
        ...
        .three { transition: 0.5s; }
        a:hover .one { transform: translateX(0%); animation: color_anim 1s infinite 0.6s; }
        a:hover .two { transform: translateX(0%); animation: color_anim 1s infinite 0.4s; }
        a:hover .three { animation: color_anim 1s infinite 0.2s; }
        @keyframes color_anim { 0%, 100% { fill: #000; } 50% { fill: white; } }
      `}</style>
    </a>
  );
}
          ...
          <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-7">
            <a href="#" className="flex items-center gap-3 text-white no-underline">
              ...
              <div>
                ...
                <div className="text-[13px] text-gray-300">Segurança · Eficiência · Resultados</div>
              </div>
            </a>
            <nav>
